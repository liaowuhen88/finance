    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <form class="form-horizontal" data-toggle="validator" enctype="application/x-www-form-urlencoded"
                  id="saveRellCollectionForm" method="post">
                <div class="row">
                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required class="form-control" id="payerAccountName"
                                               name="payerAccountName" placeholder="付款人户名">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required class="form-control" id="payerAccountNumber"
                                               name="payerAccountNumber" placeholder="付款人账号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="payerSourceAccount"
                                               name="payerSourceAccount" placeholder="付款人开户行">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required class="form-control" id="payeeAccountName"
                                               name="payeeAccountName" placeholder="收款人户名">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required class="form-control" id="payeeAccountNumber"
                                               name="payeeAccountNumber" placeholder="收款人账号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required class="form-control" id="payeeSourceAccount"
                                               name="payeeSourceAccount" placeholder="收款人开户行">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" required class="form-control" id="serialNumber"
                                               name="serialNumber" placeholder="流水号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="" required class="form-control" id="money" name="money"
                                               placeholder="金额">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" required pattern="YYYY-MM-DD" class="form-control"
                                               id="receiveDate" name="receiveDate" placeholder="回款日期">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="usage" name="usage" placeholder="用途">
                                    </div>
                                </div>
                                <div class="form-group">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/realCollection/addRealCollection.js"></script>